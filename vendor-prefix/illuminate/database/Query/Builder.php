...
use BackedEnum;
use Archetype\Vendor\Carbon\CarbonPeriod;
use Closure;
use DateTimeInterface;
use Archetype\Vendor\Illuminate\Contracts\Database\Query\Builder as BuilderContract;
use Archetype\Vendor\Illuminate\Contracts\Database\Query\ConditionExpression;
...
use Archetype\Vendor\Illuminate\Database\Concerns\BuildsQueries;
use Archetype\Vendor\Illuminate\Database\Concerns\BuildsWhereDateClauses;
use Archetype\Vendor\Illuminate\Database\Concerns\ExplainsQueries;
use Archetype\Vendor\Illuminate\Database\ConnectionInterface;
use Archetype\Vendor\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Relation;
use Archetype\Vendor\Illuminate\Database\Query\Grammars\Grammar;
use Archetype\Vendor\Illuminate\Database\Query\Processors\Processor;
use Illuminate\Pagination\Paginator;
use Archetype\Vendor\Illuminate\Support\Arr;
use Archetype\Vendor\Illuminate\Support\Collection;
use Archetype\Vendor\Illuminate\Support\LazyCollection;
...
{
    /** @use \Archetype\Vendor\Illuminate\Database\Concerns\BuildsQueries<object> */
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>|null
     */
    public $columns;
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Database\Eloquent\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Database\Eloquent\Builder<*>|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     * @return \Archetype\Vendor\Illuminate\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $table
     * @return \Archetype\Vendor\Illuminate\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $sql
     * @param  mixed  $bindings
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \Archetype\Vendor\Illuminate\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Database\Query\Builder
     */
     ...
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Database\Eloquent\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|\Closure|string  $column
     * @param  \DateTimeInterface|string|int|float|null  $operator
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Database\Eloquent\Builder<*>|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Database\Eloquent\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     *
     * @param  int|string  $id
     * @param  string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>  $columns
     * @return object|null
     */
     ...
     *
     * @param  mixed  $id
     * @param  (\Closure(): TValue)|string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>  $columns
     ...
     * @return mixed
     *
     * @throws \Archetype\Vendor\Illuminate\Database\RecordsNotFoundException
     * @throws \Archetype\Vendor\Illuminate\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>  $columns
     * @return \Archetype\Vendor\Illuminate\Support\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Support\Collection  $items
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Archetype\Vendor\Illuminate\Contracts\Pagination\Paginator
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>  $columns
     * @return int
     */
     ...
     *
     * @param  array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>  $columns
     * @return array<string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Support\LazyCollection<int, \stdClass>
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Support\Collection<array-key, mixed>
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $columns
     * @return int
     */
     ...
     *
     * @param  mixed  $value
     * @return \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Database\Query\Grammars\Grammar
     */
