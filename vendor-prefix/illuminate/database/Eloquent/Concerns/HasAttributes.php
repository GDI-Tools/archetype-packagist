...
use BackedEnum;
use Archetype\Vendor\Brick\Math\BigDecimal;
use Archetype\Vendor\Brick\Math\Exception\MathException as BrickMathException;
use Archetype\Vendor\Brick\Math\RoundingMode;
...
use Archetype\Vendor\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use Archetype\Vendor\Illuminate\Contracts\Support\Arrayable;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\AsArrayObject;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\AsCollection;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\AsEncryptedArrayObject;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\AsEncryptedCollection;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\AsEnumArrayObject;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\AsEnumCollection;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\Attribute;
use Archetype\Vendor\Illuminate\Database\Eloquent\Casts\Json;
use Archetype\Vendor\Illuminate\Database\Eloquent\InvalidCastException;
use Archetype\Vendor\Illuminate\Database\Eloquent\JsonEncodingException;
use Archetype\Vendor\Illuminate\Database\Eloquent\MissingAttributeException;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Relation;
use Archetype\Vendor\Illuminate\Database\LazyLoadingViolationException;
...
use Archetype\Vendor\Illuminate\Support\Exceptions\MathException;
use Archetype\Vendor\Illuminate\Support\Facades\Crypt;
use Archetype\Vendor\Illuminate\Support\Facades\Date;
use Archetype\Vendor\Illuminate\Support\Facades\Hash;
...
trait HasAttributes
{
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \Archetype\Vendor\Illuminate\Database\Eloquent\MissingAttributeException
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Contracts\Encryption\Encrypter
     */
     ...
     * @return bool
     *
     * @throws \Archetype\Vendor\Illuminate\Database\Eloquent\InvalidCastException
     */
