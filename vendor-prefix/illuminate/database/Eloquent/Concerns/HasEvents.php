...
use Archetype\Vendor\Illuminate\Database\Eloquent\Attributes\ObservedBy;
use Archetype\Vendor\Illuminate\Database\Eloquent\Model;
use Archetype\Vendor\Illuminate\Events\NullDispatcher;
...
trait HasEvents
{
     ...
     *
     * @param  string  $event
     * @param  \Archetype\Vendor\Illuminate\Events\QueuedClosure|callable|array|class-string  $callback
     * @return void
     */
