...
use Closure;
use Archetype\Vendor\Illuminate\Database\ClassMorphViolationException;
...
use Archetype\Vendor\Illuminate\Database\Eloquent\PendingHasThroughRelationship;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsTo;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasMany;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOne;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphMany;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphOne;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphTo;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphToMany;
use Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Pivot;
...
trait HasRelationships
{
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOne<TRelatedModel, TDeclaringModel>
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsTo<TRelatedModel, $this>
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $ownerKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphTo<\Illuminate\Database\Eloquent\Model, $this>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \Illuminate\Database\Eloquent\Model
     *
     * @param  string|\Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasMany<TIntermediateModel, covariant $this>|\Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \Archetype\Vendor\Illuminate\Database\Eloquent\PendingHasThroughRelationship<\Illuminate\Database\Eloquent\Model, $this>
     *     : (
     *          $relationship is \Illuminate\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>
     *          ? \Archetype\Vendor\Illuminate\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>>
     *          : \Archetype\Vendor\Illuminate\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $relation
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, $this, \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Pivot>
     */
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Pivot>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \Archetype\Vendor\Illuminate\Database\Eloquent\Model|null  $instance
     * @return string
     */
