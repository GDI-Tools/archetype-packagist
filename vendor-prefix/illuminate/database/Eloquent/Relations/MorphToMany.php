 ...
 * @template TPivotModel of \Illuminate\Database\Eloquent\Relations\Pivot = \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\MorphPivot
 * @template TAccessor of string = 'pivot'
 *
 * @extends \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, TPivotModel, TAccessor>
 */
class MorphToMany extends BelongsToMany
{
     ...
     *
     * @param  mixed  $ids
     * @return \Archetype\Vendor\Illuminate\Support\Collection<int, TPivotModel>
     */
