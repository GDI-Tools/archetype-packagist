 ...
 * @template TResult
 *
 * @extends \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Archetype\Vendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @param  array  $columns
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Archetype\Vendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \Archetype\Vendor\Illuminate\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     */
     ...
     *     ? \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TRelatedModel>|TValue
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Support\LazyCollection<int, TRelatedModel>
     */
