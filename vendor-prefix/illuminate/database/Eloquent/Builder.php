...
use Closure;
use Exception;
use Archetype\Vendor\Illuminate\Contracts\Database\Eloquent\Builder as BuilderContract;
use Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression;
...
use Archetype\Vendor\Illuminate\Database\Eloquent\Concerns\QueriesRelationships;
...
use Archetype\Vendor\Illuminate\Database\Query\Builder as QueryBuilder;
 ...
 *
 * @mixin \Archetype\Vendor\Illuminate\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \Archetype\Vendor\Illuminate\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \Archetype\Vendor\Illuminate\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @return ($id is (\Archetype\Vendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \Archetype\Vendor\Illuminate\Database\Eloquent\ModelNotFoundException<TModel>
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\Archetype\Vendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TModel> : TModel)
     *
     * @throws \Archetype\Vendor\Illuminate\Database\Eloquent\ModelNotFoundException<TModel>
     */
     ...
     * @return (
     *     $id is (\Archetype\Vendor\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Archetype\Vendor\Illuminate\Database\Eloquent\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Relation<\Illuminate\Database\Eloquent\Model, TModel, *>
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Support\LazyCollection<int, TModel>
     */
     ...
     *
     * @param  array<array-key, array|(\Closure(\Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\Archetype\Vendor\Illuminate\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     ...
     *
     * @param  array|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression  $columns
     * @return array
     */
