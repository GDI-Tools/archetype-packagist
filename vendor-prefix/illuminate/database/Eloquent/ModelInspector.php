...
use Archetype\Vendor\Illuminate\Contracts\Container\BindingResolutionException;
...
use Archetype\Vendor\Illuminate\Support\Facades\Gate;
...
class ModelInspector
{
     ...
     * @return array{"class": class-string<\Illuminate\Database\Eloquent\Model>, database: string, table: string, policy: class-string|null, attributes: \Archetype\Vendor\Illuminate\Support\Collection, relations: \Archetype\Vendor\Illuminate\Support\Collection, events: \Archetype\Vendor\Illuminate\Support\Collection, observers: \Archetype\Vendor\Illuminate\Support\Collection, collection: class-string<\Illuminate\Database\Eloquent\Collection<\Illuminate\Database\Eloquent\Model>>, builder: class-string<\Illuminate\Database\Eloquent\Builder<\Illuminate\Database\Eloquent\Model>>}
     *
    ...
    public function inspect($model, $connection = null)
    {
        ...
        /** @var \Archetype\Vendor\Illuminate\Database\Eloquent\Model $model */
     ...
     * @return \Archetype\Vendor\Illuminate\Support\Collection<int, array<string, mixed>>
     */
