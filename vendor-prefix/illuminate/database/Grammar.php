...
abstract class Grammar
{
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression|string|int|float  $expression
