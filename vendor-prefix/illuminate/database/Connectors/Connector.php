...
use Exception;
use Archetype\Vendor\Illuminate\Database\DetectsLostConnections;
use PDO;
use Throwable;
class Connector
{
    ...
    {
        return version_compare(phpversion(), '8.4.0', '<') ? new PDO($dsn, $username, $password, $options) : PDO::connect($dsn, $username, $password, $options);
