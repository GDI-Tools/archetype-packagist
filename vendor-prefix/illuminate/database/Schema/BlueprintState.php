...
class BlueprintState
{
     ...
     * The primary key.
     *
     * @var \Archetype\Vendor\Illuminate\Database\Schema\IndexDefinition|null
     */
    private $primaryKey;
     ...
     * The indexes.
     *
     * @var \Archetype\Vendor\Illuminate\Database\Schema\IndexDefinition[]
     */
    private $indexes;
     ...
     * The foreign keys.
     *
     * @var \Archetype\Vendor\Illuminate\Database\Schema\ForeignKeyDefinition[]
     */
    private $foreignKeys;
     ...
     * Get the primary key.
     *
     * @return \Archetype\Vendor\Illuminate\Database\Schema\IndexDefinition|null
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Support\Fluent  $command
     * @return void
     */
