...
class Builder
{
     ...
     *
     * @var \Closure(string, \Closure, string): \Archetype\Vendor\Illuminate\Database\Schema\Blueprint|null
     */
    protected $resolver;
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Schema\Blueprint
     */
     ...
     *
     * @param  \Closure(string, \Closure, string): \Archetype\Vendor\Illuminate\Database\Schema\Blueprint|null  $resolver
     * @return void
     */
