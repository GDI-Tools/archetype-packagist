...
use Archetype\Vendor\Illuminate\Database\Eloquent\Concerns\HasUlids;
use Archetype\Vendor\Illuminate\Database\Query\Expression;
use Archetype\Vendor\Illuminate\Database\Schema\Grammars\Grammar;
use Archetype\Vendor\Illuminate\Database\Schema\Grammars\MySqlGrammar;
use Archetype\Vendor\Illuminate\Database\Schema\Grammars\SQLiteGrammar;
...
class Blueprint
{
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @var \Archetype\Vendor\Illuminate\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \Archetype\Vendor\Illuminate\Database\Eloquent\Model|string  $model
     ...
     * @return \Archetype\Vendor\Illuminate\Database\Schema\IndexDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Archetype\Vendor\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Archetype\Vendor\Illuminate\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  int|null  $precision
     * @return \Archetype\Vendor\Illuminate\Support\Collection<int, \Archetype\Vendor\Illuminate\Database\Schema\ColumnDefinition>
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Database\Schema\ColumnDefinition  $definition
     * @return \Archetype\Vendor\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @return \Archetype\Vendor\Illuminate\Database\Schema\BlueprintState
     */
