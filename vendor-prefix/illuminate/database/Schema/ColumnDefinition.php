 ...
 * @method $this generatedAs(string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression $expression = null) Create a SQL compliant identity column (PostgreSQL)
 ...
 * @method $this storedAs(string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression $expression) Create a stored generated column (MySQL/PostgreSQL/SQLite)
 ...
 * @method $this virtualAs(string|\Archetype\Vendor\Illuminate\Contracts\Database\Query\Expression $expression) Create a virtual generated column (MySQL/PostgreSQL/SQLite)
 */
