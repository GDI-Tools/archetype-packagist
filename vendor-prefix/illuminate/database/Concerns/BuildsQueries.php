...
use Archetype\Vendor\Illuminate\Database\RecordNotFoundException;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\Archetype\Vendor\Illuminate\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \Archetype\Vendor\Illuminate\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Archetype\Vendor\Illuminate\Support\LazyCollection<int, TValue>
     *
     ...
     * @param  string|null  $alias
     * @param  bool  $descending
     * @return \Archetype\Vendor\Illuminate\Support\LazyCollection
     *
     * @throws \InvalidArgumentException
     */
     ...
     * @return TValue
     *
     * @throws \Archetype\Vendor\Illuminate\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Database\Query\Builder|\Archetype\Vendor\Illuminate\Database\Eloquent\Builder<*>  $builder
