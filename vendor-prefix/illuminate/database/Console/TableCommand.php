...
use Archetype\Vendor\Illuminate\Support\Number;
use Archetype\Vendor\Symfony\Component\Console\Attribute\AsCommand;
use function Archetype\Vendor\Laravel\Prompts\select;
...
class TableCommand extends DatabaseInspectionCommand
{
    ...
    public function handle(ConnectionResolverInterface $connections)
    {
        ...
        $tableName = $this->argument('table') ?: select('Which table would you like to inspect?', array_keys($tables));
