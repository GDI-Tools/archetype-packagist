...
use Archetype\Vendor\Illuminate\Support\Testing\Fakes\QueueFake;
 ...
 * @method static \Illuminate\Queue\QueueManager setApplication(\Archetype\Vendor\Illuminate\Contracts\Foundation\Application $app)
 ...
 * @method static \Archetype\Vendor\Illuminate\Container\Container getContainer()
 * @method static void setContainer(\Archetype\Vendor\Illuminate\Container\Container $container)
 * @method static \Archetype\Vendor\Illuminate\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \Archetype\Vendor\Illuminate\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static \Archetype\Vendor\Illuminate\Support\Collection pushedRaw(null|\Closure $callback = null)
 * @method static \Archetype\Vendor\Illuminate\Support\Collection listenersPushed(string $listenerClass, \Closure|null $callback = null)
 ...
 * @method static \Archetype\Vendor\Illuminate\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \Illuminate\Queue\QueueManager
 * @see \Illuminate\Queue\Queue
 * @see \Archetype\Vendor\Illuminate\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \Archetype\Vendor\Illuminate\Support\Testing\Fakes\QueueFake
     */
