...
use Closure;
use Archetype\Vendor\Illuminate\Bus\Events\BatchDispatched;
use Archetype\Vendor\Illuminate\Contracts\Container\Container;
use Archetype\Vendor\Illuminate\Contracts\Events\Dispatcher as EventDispatcher;
...
class PendingBatch
{
     ...
     *
     * @param  \Archetype\Vendor\Illuminate\Bus\Batch  $batch
     * @return void
     *
     * @throws \Throwable
     */
