...
use Archetype\Vendor\Illuminate\Foundation\Bus\PendingChain;
use Archetype\Vendor\Illuminate\Pipeline\Pipeline;
use Archetype\Vendor\Illuminate\Queue\InteractsWithQueue;
use Archetype\Vendor\Illuminate\Queue\Jobs\SyncJob;
...
class Dispatcher implements QueueingDispatcher
{
     ...
     * @var bool
     */
    protected $allowsDispatchingAfterResponses = \true;
    /**
    ...
    {
        $this->allowsDispatchingAfterResponses = \true;
        return $this;
    }
    /**
