 ...
 * Usage:
 *
 *     Analog::handler (Archetype\Vendor\Analog\Handler\FirePHP::init ());
 *     
...
class FirePHP {
	...
	private static $log_levels = array (
		\Archetype\Vendor\Analog\Analog::DEBUG    => 'LOG',
		\Archetype\Vendor\Analog\Analog::INFO     => 'INFO',
		\Archetype\Vendor\Analog\Analog::NOTICE   => 'INFO',
		\Archetype\Vendor\Analog\Analog::WARNING  => 'WARN',
		\Archetype\Vendor\Analog\Analog::ERROR    => 'ERROR',
		\Archetype\Vendor\Analog\Analog::CRITICAL => 'ERROR',
		\Archetype\Vendor\Analog\Analog::ALERT    => 'ERROR',
		\Archetype\Vendor\Analog\Analog::URGENT   => 'ERROR'
	);
