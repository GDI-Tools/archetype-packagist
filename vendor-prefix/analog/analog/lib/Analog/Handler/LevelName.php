 ...
 * 
 *     Analog::handler (Archetype\Vendor\Analog\Handler\LevelName::init (
...
class LevelName {
	...
	private static $log_levels = array (
		\Archetype\Vendor\Analog\Analog::DEBUG    => 'DEBUG',
		\Archetype\Vendor\Analog\Analog::INFO     => 'INFO',
		\Archetype\Vendor\Analog\Analog::NOTICE   => 'NOTICE',
		\Archetype\Vendor\Analog\Analog::WARNING  => 'WARNING',
		\Archetype\Vendor\Analog\Analog::ERROR    => 'ERROR',
		\Archetype\Vendor\Analog\Analog::CRITICAL => 'CRITICAL',
		\Archetype\Vendor\Analog\Analog::ALERT    => 'ALERT',
		\Archetype\Vendor\Analog\Analog::URGENT   => 'URGENT'
	);
