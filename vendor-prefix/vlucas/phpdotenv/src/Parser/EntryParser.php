...
use Archetype\Vendor\GrahamCampbell\ResultType\Error;
...
final class EntryParser
{
     ...
     * @param string $line
     *
     * @return \Archetype\Vendor\GrahamCampbell\ResultType\Result<array{string, string|null},string>
     */
    private static function splitStringIntoParts(string $line)
    {
        ...
        if ($result[0] === '') {
            /** @var \Archetype\Vendor\GrahamCampbell\ResultType\Result<array{string, string|null},string> */
     ...
     * @param string $name
     *
     * @return \Archetype\Vendor\GrahamCampbell\ResultType\Result<string, string>
     */
    private static function parseName(string $name)
    {
        ...
        if (!self::isValidName($name)) {
            /** @var \Archetype\Vendor\GrahamCampbell\ResultType\Result<string, string> */
     ...
     * @param string $value
     *
     * @return \Archetype\Vendor\GrahamCampbell\ResultType\Result<\Dotenv\Parser\Value, string>
     */
    private static function parseValue(string $value)
    {
        if (\trim($value) === '') {
            /** @var \Archetype\Vendor\GrahamCampbell\ResultType\Result<\Dotenv\Parser\Value, string> */
     ...
     * @param string $token
     *
     * @return \Archetype\Vendor\GrahamCampbell\ResultType\Result<array{string, bool, int}, string>
     */
    private static function processToken(int $state, string $token)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($token === '\'') {
                    /** @var \Archetype\Vendor\GrahamCampbell\ResultType\Result<array{string, bool, int}, string> */
