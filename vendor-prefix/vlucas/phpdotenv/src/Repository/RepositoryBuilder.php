...
use Archetype\Vendor\Dotenv\Repository\Adapter\AdapterInterface;
use Archetype\Vendor\Dotenv\Repository\Adapter\EnvConstAdapter;
use Archetype\Vendor\Dotenv\Repository\Adapter\GuardedWriter;
use Archetype\Vendor\Dotenv\Repository\Adapter\ImmutableWriter;
use Archetype\Vendor\Dotenv\Repository\Adapter\MultiReader;
use Archetype\Vendor\Dotenv\Repository\Adapter\MultiWriter;
use Archetype\Vendor\Dotenv\Repository\Adapter\ReaderInterface;
use Archetype\Vendor\Dotenv\Repository\Adapter\ServerConstAdapter;
...
final class RepositoryBuilder
{
     ...
     *
     * @return \Archetype\Vendor\Dotenv\Repository\RepositoryBuilder
     */
     ...
     *
     * @param \Archetype\Vendor\Dotenv\Repository\Adapter\ReaderInterface|string $reader
     *
     ...
     * the adapter is not supported, then we silently skip adding it.
     *
     * @param \Archetype\Vendor\Dotenv\Repository\Adapter\WriterInterface|string $writer
     *
     * @throws \InvalidArgumentException
     *
     * @return \Archetype\Vendor\Dotenv\Repository\RepositoryBuilder
     ...
     *
     * @param \Archetype\Vendor\Dotenv\Repository\Adapter\WriterInterface|string $adapter
     *
     * @throws \InvalidArgumentException
     *
     * @return \Archetype\Vendor\Dotenv\Repository\RepositoryBuilder
     ...
     *
     * @return \Archetype\Vendor\Dotenv\Repository\RepositoryInterface
     */
