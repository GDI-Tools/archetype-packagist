...
namespace Archetype\Vendor\Brick\Math;

use Archetype\Vendor\Brick\Math\Exception\DivisionByZeroException;
use Archetype\Vendor\Brick\Math\Exception\IntegerOverflowException;
use Archetype\Vendor\Brick\Math\Exception\MathException;
use Archetype\Vendor\Brick\Math\Exception\NegativeNumberException;
use Archetype\Vendor\Brick\Math\Exception\NumberFormatException;
use Archetype\Vendor\Brick\Math\Internal\Calculator;
use Override;
/**
