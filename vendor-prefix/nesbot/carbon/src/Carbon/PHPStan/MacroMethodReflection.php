 ...
 */
namespace Archetype\Vendor\Carbon\PHPStan;

use Archetype\Vendor\PHPStan\Reflection\ClassReflection;
use Archetype\Vendor\PHPStan\Reflection\MethodReflection;
use Archetype\Vendor\PHPStan\Reflection\ParametersAcceptor;
use Archetype\Vendor\PHPStan\TrinaryLogic;
use Archetype\Vendor\PHPStan\Type\Type;
...
class MacroMethodReflection implements MethodReflection
{
    ...
    public function getPrototype(): \Archetype\Vendor\PHPStan\Reflection\ClassMemberReflection
    {
        return $this;
    }
