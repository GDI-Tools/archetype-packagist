...
return [
    ...
    'calendar' => [
        ...
        'nextDay' => '[Завтра, в] LT',
        'nextWeek' => static function (CarbonInterface $current, \Archetype\Vendor\Carbon\CarbonInterface $other) {
        ...
        'lastDay' => '[Вчера, в] LT',
        'lastWeek' => static function (CarbonInterface $current, \Archetype\Vendor\Carbon\CarbonInterface $other) {
            if ($current->week !== $other->week) {
                switch ($current->dayOfWeek) {
                    case 0:
