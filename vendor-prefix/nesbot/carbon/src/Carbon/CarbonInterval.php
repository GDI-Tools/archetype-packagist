...
use Archetype\Vendor\Carbon\Exceptions\BadFluentConstructorException;
use Archetype\Vendor\Carbon\Exceptions\BadFluentSetterException;
use Archetype\Vendor\Carbon\Exceptions\InvalidCastException;
use Archetype\Vendor\Carbon\Exceptions\InvalidFormatException;
use Archetype\Vendor\Carbon\Exceptions\InvalidIntervalException;
use Archetype\Vendor\Carbon\Exceptions\OutOfRangeException;
use Archetype\Vendor\Carbon\Exceptions\ParseErrorException;
use Archetype\Vendor\Carbon\Exceptions\UnitNotConfiguredException;
use Archetype\Vendor\Carbon\Exceptions\UnknownGetterException;
use Archetype\Vendor\Carbon\Exceptions\UnknownSetterException;
use Archetype\Vendor\Carbon\Exceptions\UnknownUnitException;
use Archetype\Vendor\Carbon\Traits\IntervalRounding;
use Archetype\Vendor\Carbon\Traits\IntervalStep;
use Archetype\Vendor\Carbon\Traits\LocalFactory;
use Archetype\Vendor\Carbon\Traits\MagicParameter;
use Archetype\Vendor\Carbon\Traits\Mixin;
use Archetype\Vendor\Carbon\Traits\Options;
use Archetype\Vendor\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
use DateTime;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \Archetype\Vendor\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
     ...
     *
     * @param \Archetype\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $start
     * @param \Archetype\Vendor\Carbon\Carbon|\DateTimeInterface|mixed $end
     *
     * @return static
     */
