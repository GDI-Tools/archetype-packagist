...
use Archetype\Vendor\Carbon\Exceptions\InvalidTypeException;
use Archetype\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use Archetype\Vendor\Carbon\Language;
use Archetype\Vendor\Carbon\Translator;
use Archetype\Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
...
trait Localization
{
     ...
     * @param \Archetype\Vendor\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
