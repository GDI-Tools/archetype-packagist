...
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\DB2Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\KeywordList;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\MariaDb102Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\MySQL57Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\MySQL80Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\MySQL84Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\MySQLKeywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\OracleKeywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\PostgreSQL100Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\PostgreSQL94Keywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\ReservedKeywordsValidator;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\SQLiteKeywords;
use Archetype\Vendor\Doctrine\DBAL\Platforms\Keywords\SQLServer2012Keywords;
...
class ReservedWordsCommand extends Command
{
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/5431', 'ReservedWordsCommand is deprecated. Use database documentation instead.');
        parent::__construct();
...
EOT
    ...
    {
        $output->writeln('<comment>The <info>dbal:reserved-words</info> command is deprecated.</comment>' . ' Use the documentation on the used database platform(s) instead.');
        $output->writeln('');
