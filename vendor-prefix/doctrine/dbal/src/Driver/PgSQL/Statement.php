...
use Archetype\Vendor\Doctrine\DBAL\Driver\PgSQL\Exception\UnknownParameter;
        ...
        foreach ($this->parameters as $parameter => $value) {
            switch ($this->parameterTypes[$parameter]) {
                ...
                case ParameterType::LARGE_OBJECT:
                    $escapedParameters[] = $value === null ? null : pg_escape_bytea($this->connection, is_resource($value) ? stream_get_contents($value) : $value);
                    break;
                default:
