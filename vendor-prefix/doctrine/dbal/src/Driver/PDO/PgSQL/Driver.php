...
namespace Archetype\Vendor\Doctrine\DBAL\Driver\PDO\PgSQL;
...
final class Driver extends AbstractPostgreSQLDriver
{
    ...
    private function constructPdoDsn(array $params): string
    {
        ...
        if (isset($params['dbname'])) {
            ...
            Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/5705', 'The "default_dbname" connection parameter is deprecated. Use "dbname" instead.');
            $dsn .= 'dbname=' . $params['default_dbname'] . ';';
        } else {
            if (isset($params['user']) && $params['user'] !== 'postgres') {
                Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/5705', 'Relying on the DBAL connecting to the "postgres" database by default is deprecated.' . ' Unless you want to have the server determine the default database for the connection,' . ' specify the database name explicitly.');
            }
