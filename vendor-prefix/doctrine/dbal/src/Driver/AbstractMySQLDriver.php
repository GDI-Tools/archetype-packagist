...
use Archetype\Vendor\Doctrine\DBAL\Driver\API\MySQL;
use Archetype\Vendor\Doctrine\DBAL\Exception;
use Archetype\Vendor\Doctrine\DBAL\Platforms\AbstractMySQLPlatform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\AbstractPlatform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MariaDb1010Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MariaDb1027Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MariaDb1043Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MariaDb1052Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MariaDb1060Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MySQL57Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MySQL80Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MySQL84Platform;
use Archetype\Vendor\Doctrine\DBAL\Platforms\MySQLPlatform;
use Archetype\Vendor\Doctrine\DBAL\Schema\MySQLSchemaManager;
