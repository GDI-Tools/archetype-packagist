...
use Archetype\Vendor\Doctrine\DBAL\Driver\IBMDB2\Exception\CannotCopyStreamToStream;
use Archetype\Vendor\Doctrine\DBAL\Driver\IBMDB2\Exception\CannotCreateTemporaryFile;
