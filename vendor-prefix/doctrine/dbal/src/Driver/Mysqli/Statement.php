...
use Archetype\Vendor\Doctrine\DBAL\Driver\Mysqli\Exception\FailedReadingStreamOffset;
use Archetype\Vendor\Doctrine\DBAL\Driver\Mysqli\Exception\NonStreamResourceUsedAsLargeObject;
use Archetype\Vendor\Doctrine\DBAL\Driver\Mysqli\Exception\StatementError;
...
{
    private const PARAM_TYPE_MAP = [ParameterType::ASCII => 's', ParameterType::STRING => 's', ParameterType::BINARY => 's', ParameterType::BOOLEAN => 'i', ParameterType::NULL => 's', ParameterType::INTEGER => 'i', ParameterType::LARGE_OBJECT => 'b'];
