...
use Archetype\Vendor\Doctrine\DBAL\ArrayParameters\Exception\MissingNamedParameter;
use Archetype\Vendor\Doctrine\DBAL\ArrayParameters\Exception\MissingPositionalParameter;
