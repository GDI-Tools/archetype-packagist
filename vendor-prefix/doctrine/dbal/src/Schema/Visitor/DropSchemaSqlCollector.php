...
class DropSchemaSqlCollector extends AbstractVisitor
{
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/5416', 'DropSchemaSqlCollector is deprecated. Use DropSchemaObjectsSQLBuilder instead.');
